      ...
      <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 border-b border-border-dark grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div className="space-y-6">
          <h2 className="text-3xl sm:text-4xl font-display font-bold">
            Own a Gaming <span className="text-gradient">Cafe or Turf?</span>
          </h2>
          <p className="text-text-secondary leading-relaxed">
            Put your sports setups and computer rigs on India's premium recreation booking channel. Fill offline empty gaps, automate slot hold timers, track payments, and access detailed revenue payout audits easily.
          </p>
